...
$stmt = $_db->prepare(
    'SELECT p.product_id AS id, p.product_name AS name, p.price, p.availability,
...
<dialog id="wishlist-confirm-dialog" aria-labelledby="wishlist-confirm-message">
    ...
    <div class="wishlist-confirm-actions">
        <button id="wishlist-confirm-cancel" type="button">Cancel</button>
        <button id="wishlist-confirm-remove" type="button">Remove</button>
    </div>
</dialog>
